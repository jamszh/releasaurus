...
const examples: [string, string][] = [
  ...
  [`$0 -a your-auth-token -r jamszh/lib-dino -p ${releaseRoot}/lib-dino`, 'Create notes page for the latest release of "lib-dino"'],
  [`$0 -a your-auth-token -r jamszh/lib-dino -p ${releaseRoot}/lib-dino-v "1.0.0"`, 'Create notes page for v1.0.0'],
]
